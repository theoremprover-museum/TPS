...
%============================================================================
%--- New version written by Remy Chretien, December 2010
%--- 'def' changed to 'def-insert' to avoid conflict with TPS code.
%--- 'const' changed to 'const-insert' to avoid conflict with TPS code.
%--- 'thm' changed to 'thm-insert' to avoid conflict with TPS code.
%--- 'axiom' changed to 'axiom-insert' to avoid conflict with TPS code.
%----------------------------------------------------------------------------
