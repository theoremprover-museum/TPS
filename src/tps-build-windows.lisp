...
(load-module 'tpsdef)
(load-module 'bare)			; Loads everything but the
					; above four files.
...
(in-mode ml (load-module 'math-logic-2-wffs))
...
(in-mode ml (load-module 'math-logic-2-exercises))
...
(in-mode rules
	 (in-mode ml (load-module 'ml2-rewrite)))

(init-events)

(setq core::*always-compile-source-if-newer* nil)
